...
class GamesPagingSourceTest {
    @Test
    fun `load returns LoadResult_Page with data when successful`() = runTest {
        // Arrange
    ...
    @Test
    fun `load returns LoadResult_Page with empty data when no more data`() = runTest {
        // Arrange
    ...
    @Test
    fun `load returns LoadResult_Error when Result is Error`() = runTest {
        // Arrange
    ...
    @Test
    fun `load returns LoadResult_Error when exception is thrown`() = runTest {
        // Arrange
